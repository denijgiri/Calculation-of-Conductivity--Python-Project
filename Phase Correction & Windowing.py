...
for i in range(10):
     ...
     plt.plot(freqs,sigma.real, label='f{"Real part of conductivity"(i)}')
plt.legend()
plt.show()
...
#plt.figure()
#plt.plot(freqs, sigma.real, color = 'red')
#plt.plot(freqs, results.imag, color = 'blue')
#plt.fill_between(freqs, sigma.real + std.real, sigma.real - std.real, alpha=0.5, edgecolor='#CC4F1B', facecolor='#FF9848')
#plt.show()
